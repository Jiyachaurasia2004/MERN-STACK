    ...
    <section id="about" className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="text-center mb-16">
          ...
          >
            Master the complete MERN stack ecosystem through hands-on projects and deep dives into core concepts.
          </motion.p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {cards.map((card, index) => (
            <motion.div
              ...
              whileHover={{ y: -10 }}
              className={`glass-card rounded-2xl p-8 border-t-2 bg-gradient-to-b ${card.gradient} transition-all duration-300 ${card.hoverGlow}`}
            >
              <div className="mb-6 inline-block p-4 rounded-2xl bg-white dark:bg-black/40 border border-gray-200 dark:border-white/5 shadow-inner transition-colors duration-500">
                {card.icon}
              </div>
